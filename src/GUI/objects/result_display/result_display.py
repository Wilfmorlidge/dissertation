...
def result_display(root,display_height, display_width):
    ...
    def update_main_body(object_container):
        ...
        accuracy_display = tk.Label(accuracy_container,text=f"{current_cumulative_values['accuracy']:.{3}f}",bg='dimgray',fg='white',font=('helvetica',20))
        ...
        mean_pertubation_display = tk.Label(mean_pertubation_container,text=f"{current_cumulative_values['mean_pertubation']:.{3}f}",bg='dimgray',fg='white',font=('helvetica',20))
        ...
        GMQ_display = tk.Label(GMQ_container,text=f"{current_cumulative_values['GMQ']:.{3}f}",bg='dimgray',fg='white',font=('helvetica',20))
        ...
        Sharpe_ratio_display = tk.Label(Sharpe_ratio_container,text=f"{current_cumulative_values['Sharpe_ratio']:.{3}f}",bg='dimgray',fg='white',font=('helvetica',20))
